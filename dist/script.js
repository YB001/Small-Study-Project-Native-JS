...
var checkNumImputs = function checkNumImputs(selector) {
  ...
  numInputs.forEach(function (item) {
    item.addEventListener('input', function () {
      item.value = item.value.replace(/\D/, ''); //валидация ввода - только цифры
    });
  });
};
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        document.body.classList.add('modal-open'); // используем классы библиотеки Bootstrap
      });
    });
    close.addEventListener('click', function () {
      ...
      document.body.classList.remove('modal-open'); // используем классы библиотеки Bootstrap
    });
